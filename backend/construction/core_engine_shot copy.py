...
print("    Features: Auto-Correlation Filter, HEA Ansatz, Checkpointing")
print("=" * 65)
...
def compute_nystrom_stateful(X_train, X_test, backend):
    ...
    print("\n[RECONSTRUCT] Building Final Kernel...")
    ...
    return (K_train_approx + K_train_approx.T) / 2.0, K_test_approx
