...
export default function StatCard({
  ...
  return (
    <motion.div
      ...
      className="liquid-glass rounded-3xl p-5 transition-all duration-300 relative overflow-hidden group cursor-default"
    >
      {/* Shimmer on hover */}
      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at top left, ${cfg.from}10, transparent 70%)`,
          }}
        />
      </div>
