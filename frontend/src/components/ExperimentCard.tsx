...
export default function ExperimentCard({ name, protein, status, score, date, index = 0 }: ExperimentCardProps) {
  return (
    ...
    >
      <MagicCard className="rounded-2xl p-5" gradientOpacity={0.4}>
        {/* Hover border glow transparently over top */}
        <div className="absolute inset-0 rounded-2xl border border-transparent group-hover:border-quantum/20 transition-colors duration-300 pointer-events-none" />
